...
#define NETWORK_NETPROTOCOL_NONE			-1
#define NETWORK_NETPROTOCOL_UNSUPPORTED		0
#define NETWORK_NETPROTOCOL_ARP				1
#define NETWORK_NETPROTOCOL_IP4				2
#define NETWORK_NETPROTOCOL_IP6				3
...
#define NETWORK_TRANSPROTOCOL_NONE			-1
#define NETWORK_TRANSPROTOCOL_UNSUPPORTED	0
