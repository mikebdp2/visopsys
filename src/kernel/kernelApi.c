...
static kernelArgInfo args_cryptHashMd5[] =
	{ { 1, type_ptr, API_ARG_NONNULLPTR | API_ARG_USERPTR },
		...
		{ 1, type_val, API_ARG_ANYVAL },
		{ 1, type_val, API_ARG_ANYVAL } };
static kernelArgInfo args_cryptHashMd5Cont[] =
	{ { 1, type_ptr, API_ARG_NONNULLPTR | API_ARG_USERPTR },
		{ 1, type_val, API_ARG_ANYVAL },
		{ 1, type_ptr, API_ARG_NONNULLPTR | API_ARG_USERPTR },
		{ 1, type_val, API_ARG_ANYVAL },
...
static kernelFunctionIndex miscFunctionIndex[] = {
	...
	{ _fnum_cryptHashMd5, kernelCryptHashMd5,
		PRIVILEGE_USER, 5, args_cryptHashMd5, type_val },
	{ _fnum_cryptHashMd5Cont, kernelCryptHashMd5Cont,
		PRIVILEGE_USER, 5, args_cryptHashMd5Cont, type_val },
...
void kernelApi(unsigned CS __attribute__((unused)), unsigned *args)
{
	...
	if (currentPriv < 0)
	{
		kernelError(kernel_error, "Couldn't determine current privilege "
			"level in call to API function %x",
