...
errno             Print the error message associated with a numeric error code
...
md5pass           Calculate and print MD5 digests of strings
md5sum            Calculate and print MD5 digests of files
