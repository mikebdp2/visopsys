...
// This is the standard "strcasestr" function, as found in standard C
// libraries
...
char *strcasestr(const char *s1, const char *s2)
{
	...
	// s2 in the string s1, ignoring case.  The terminating `\0' characters
	// are not compared.  The strcasestr() function returns a pointer to the
