...
time_t mktime(struct tm *timeStruct)
{
	...
	// Add 1 day's worth of seconds for every complete leap year.  There is a
	// leap year in every year divisible by 4 except for years which are both
	// divisible by 100 not by 400.  Got it?
