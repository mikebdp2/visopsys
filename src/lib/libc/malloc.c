...
// These functions comprise Visopsys heap memory management system.  They rely
// upon the kernelMemory code, and do similar things, but instead of whole
// memory pages, they allocate arbitrary-sized chunks.
