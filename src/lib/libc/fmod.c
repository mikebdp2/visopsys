...
double fmod(double x, double y)
{
	...
	// In other words, the fmod() function returns the value x - n * y, for
	// some integer n such that, if y is non-zero, the result has the same
	// sign as x and magnitude less than the magnitude of y
