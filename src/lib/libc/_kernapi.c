...
_X_ int cryptHashMd5(const unsigned char *in, unsigned len _U_, unsigned char *out _U_, int finalize _U_, unsigned total _U_)
{
	// Proto: kernelCryptHashMd5(const unsigned char *, unsigned, unsigned char *, int, unsigned);
	// Desc : Given the input data 'in' and length 'len', return the numerical message digest in the buffer 'out'.  If more data is to be hashed with a call to cryptHashMd5Cont(), then 'len' must be a multiple of 512 bits (64 bytes).  Otherwise (i.e. this is the end of the data) then 'finalize' must be non-zero, and the number of input bytes of the entire input must be supplied in 'total'.
	return (_syscall(_fnum_cryptHashMd5, &in));
}

_X_ int cryptHashMd5Cont(const unsigned char *in, unsigned len _U_, unsigned char *out _U_, int finalize _U_, unsigned total _U_)
{
	// Proto: kernelCryptHashMd5Cont(const unsigned char *, unsigned, unsigned char *, int, unsigned);
	...
	return (_syscall(_fnum_cryptHashMd5Cont, &in));
}

_X_ int cryptHashSha1(const unsigned char *in, unsigned len _U_, unsigned char *out _U_, int finalize _U_, unsigned total _U_)
{
	// Proto: kernelCryptHashSha1(const unsigned char *, unsigned, unsigned char *, int, unsigned);
...
{
	// Proto: kernelCryptHashSha1Cont(const unsigned char *, unsigned, unsigned char *, int, unsigned);
	// Desc : Given the input data 'in' and length 'len', and a starting hash value in 'out' (obtained from a previous call) return the numerical message digest in the buffer 'out'.  If more data is to be hashed with further calls to this function, then 'len' must be a multiple of 512 bits (64 bytes).  Otherwise (i.e. this is the end of the data) then 'finalize' must be non-zero, and the number of input bytes of the entire input must be supplied in 'total'.
...
{
	// Proto: kernelCryptHashSha256(const unsigned char *, unsigned, unsigned char *, int, unsigned);
...
{
	// Proto: kernelCryptHashSha256Cont(const unsigned char *, unsigned, unsigned char *, int, unsigned);
	// Desc : Given the input data 'in' and length 'len', and a starting hash value in 'out' (obtained from a previous call) return the numerical message digest in the buffer 'out'.  If more data is to be hashed with further calls to this function, then 'len' must be a multiple of 512 bits (64 bytes).  Otherwise (i.e. this is the end of the data) then 'finalize' must be non-zero, and the number of input bytes of the entire input must be supplied in 'total'.
