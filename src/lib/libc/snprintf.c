...
{
	// This function will construct a single string out of the format string,
	// and arguments that are passed, up to 'size' bytes.  Returns the number
	// of characters copied to the output string.
