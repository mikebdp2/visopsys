...
rm -Rf $(realpath "$DESTDIR"/toolchain/binutils/src)
rm -f "$DESTDIR"/toolchain/binutils/src
rm -Rf $(realpath "$DESTDIR"/toolchain/gcc/src)
rm -f "$DESTDIR"/toolchain/gcc/src
rm -Rf "$DESTDIR"/toolchain/x86
