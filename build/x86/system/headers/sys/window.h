...
// This file describes things needed for interaction with the kernel's window
// manager and the Visopsys GUI
...
// Window events/masks.  This first batch are "tier 2" events, produced by the
// system, windows, widgets, etc. to indicate that some more abstract thing
// has happened
...
// This structure is needed to describe parameters consistent to all window
// components
typedef struct {
...
// A structure for specifying display percentage and display position in
...
int windowCancelDialogDestroy(objectKey);
...
objectKey windowNewCancelDialog(objectKey, const char *, const char *,
	void (*)(objectKey));
