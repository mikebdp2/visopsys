...
typedef struct {
	...
	unsigned char encrypt_algos[4];		// 0x254
	unsigned char encrypt_pw_salt[16];	// 0x258
	unsigned lpf_ino;					// 0x268
	unsigned prj_quota_inum;			// 0x26C
	unsigned checksum_seed;				// 0x270
	unsigned reserved[98];				// 0x274
...
} __attribute__((packed)) extGroupDesc32;

typedef struct {
	extGroupDesc32 g32;
	unsigned block_bitmap_hi;			// 0x20
	unsigned inode_bitmap_hi;			// 0x24
	unsigned inode_table_hi;			// 0x28
	unsigned short free_blocks_count_hi; // 0x2C
	unsigned short free_inodes_count_hi; // 0x2E
	unsigned short used_dirs_count_hi;	// 0x30
	unsigned short itable_unused_hi;	// 0x32
	unsigned exclude_bitmap_hi;			// 0x34
	unsigned short block_bitmap_csum_hi; // 0x38
	unsigned short inode_bitmap_csum_hi; // 0x3A
	unsigned reserved;					// 0x3C

} __attribute__((packed)) extGroupDesc64;
...
} __attribute__((packed)) extExtentFixed;
